...
public final class SwerveConstants {
    ...
    private static final Pigeon2Configuration pigeonConfigs = new Pigeon2Configuration()
            .withMountPose(new MountPoseConfigs()
                    .withMountPoseYaw(-180.00013732910156)
                    .withMountPosePitch(-87.65)
                    .withMountPoseRoll(-30.0));
//    private static final Pigeon2Configuration pigeonConfigs = new Pigeon2Configuration()
//            .withMountPose(new MountPoseConfigs()
//                    .withMountPoseYaw(-173.65603637695312)
//                    .withMountPosePitch(-85.11724090576172)
//                    .withMountPoseRoll(-25.535856246948242));
